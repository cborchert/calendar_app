...
-   Used [this page](https://github.com/facebookincubator/create-react-app/tree/master/packages/eslint-config-react-app) for ESLinting
-   Used [this page](https://github.com/facebookincubator/create-react-app/blob/master/packages/react-scripts/template/README.md#adding-a-css-preprocessor-sass-less-etc) for SCSS
-   If `npm start` is not working, try the following thanks to [this thread](https://stackoverflow.com/questions/39959900/npm-start-error-with-create-react-app):
  - `sudo npm install -g npm@latest` to update npm because it is sometimes buggy.
